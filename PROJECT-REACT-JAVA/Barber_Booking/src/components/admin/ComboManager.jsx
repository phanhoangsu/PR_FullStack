...
//     { serviceId: null, quantity: 1, price: 0 },
//   ]);
//   const [editingCombo, setEditingCombo] = useState(null); // combo đang sửa
...
//   const handleDelete = async (comboName) => {
//     try {
//       await dispatch(deleteCombo(comboName)).unwrap();
...
//       render: (_, record) => (
//         <div>
//           <Button onClick={() => openEditModal(record)} className="mr-2">
//             Sửa
//           </Button>
//           <Popconfirm
//             title="Xoá combo?"
//             onConfirm={() => handleDelete(record.comboName)}
//           >
